...
export default function Home() {
  const featuredPost = sortedPosts.find((post) => standardizePath(post._meta.path) === FEATURED_POST_SLUG) ?? sortedPosts[0];
  const recentPosts = sortedPosts
    .filter((post) => standardizePath(post._meta.path) !== standardizePath(featuredPost?._meta.path))
